...
// Removed imports for 'next/link' and 'next/image' to fix the "Could not resolve" errors.
...
export default function ProjectsPage() { 
    // --- Custom Styles and Config (Normally in a dedicated file/setup in Next.js) ---
    const customStyles = `
        body {
    ...
    return (
        <>
            <title>Jirawad - Portfolio Projects</title>
            ...
            {/* Inject custom CSS and Tailwind config */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="profile-card lg:col-span-1 p-6 md:p-8 rounded-2xl shadow-2xl bg-dark-card border border-gray-700/50">
                            ...
                            <div className="mb-6 overflow-hidden rounded-2xl border-4 border-gray-700 w-48 h-48 mx-auto relative">
                                {/* Reverted to <img> and applied necessary classes for layout */}
                                <img 
                                    src="/avatar.png" 
                                    alt="Profile Avatar" 
                        ...
                        <div className="main-content lg:col-span-2 p-6 md:p-8 rounded-2xl">
                            ...
                            <div className="bg-dark-card p-6 md:p-8 rounded-xl shadow-xl border-t-4 border-primary-orange">
                                ...
                                <p className="text-gray-400 text-base mb-6">
                                    {/* Unescaped entity fix remains here */}
                    ...
                    <nav className="flex flex-col space-y-4 text-gray-400">
                        {navLinks.map((link, index) => (
                            ...
                            <a 
                              key={index}
                              href={link.href} 
                              className={`p-2 rounded-full hover:text-primary-orange transition duration-200 ${index === 3 ? 'sidebar-active' : 'hover:bg-gray-700'}`} // index 3 is 'Portfolio/Works'
                              title={link.title}
                            >
